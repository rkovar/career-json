...
tests/              476 assertions plus a skill-invariant lint
...
`make check` runs 476 assertions: real tests over the scripts, plus a lint
...
were visible to three hundred passing476 assertions; all three appeared within one
