...
tests/              473 assertions plus a skill-invariant lint
...
`make check` runs 473 assertions: real tests over the scripts, plus a lint
...
were visible to three hundred passing473 assertions; all three appeared within one
