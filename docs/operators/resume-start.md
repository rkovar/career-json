# Resume setup: assistant reference

This is the operator contract for the resume wizard. The person uses
[Create a resume](../resume-start.md); do not ask them to edit JSON.

## Assistant workflow

Follow [the shared startup contract](career-start.md) for conversation, answer states and
