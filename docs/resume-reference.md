# Resume technical reference

For normal use, follow [Create a resume](resume-start.md). The assistant handles
the commands and saved records described below.

| Topic | Reference |
| --- | --- |
| Component responsibilities and workflow | [Resume workflow](resume-workflow.md) |
| Target and preference setup contract | [Resume setup: assistant reference](operators/resume-start.md) |
...
| Versions, archive installation and upgrades | [Releases](releases.md) |
